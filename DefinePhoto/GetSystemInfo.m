...
@implementation GetSystemInfo


//static GetSystemInfo  *_instance = nil;
//
...
+ (NSString *)getTelephonyInfo {
    ...
    //评接运营商和网络类型
    NSString *mCarrier = [NSString stringWithFormat:@"%@ %@",[carrier carrierName], info.currentRadioAccessTechnology];
